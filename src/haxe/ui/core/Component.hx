...
class Component implements IEventDispatcher {
	...
	@:isVar public var width(get_width, set_width):Float = 0;
	@:isVar public var height(get_height, set_height):Float = 0;
	...
	@:isVar public var currentStyle(get_currentStyle, set_currentStyle):Dynamic;
